...
const ServiceItem = () => {
  return (
    ...
    <Image src="/images/web-image.png" alt=" Web Saytlarin Hazirlanmasi  "layout="fill"  className='hover:scale-125 transition-all cursor-pointer ' />
        </div>
       </div>
        <div className='p-[25px] text-white ' >
           <h1 className='text-xl font-semibold pb-4 text-center'> Web Sayt</h1>
