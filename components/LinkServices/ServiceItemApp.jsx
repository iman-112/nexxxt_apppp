...
const ServiceItemApp = () => {
  return (
    ...
    <img src="/images/app-image.png" alt=" "layout="fill"  className='hover:scale-125 transition-all cursor-pointer ' />
        </div>
       </div>
        <div className='p-[25px] text-white ' >
           <h4 className='text-xl font-semibold pb-4 text-center'> Texniki Xidmət </h4>
           ...
           <button className='btn-primary '>
            <Link href="/xidmetler/texniki_xidmet">
            Daha Ətraflı
            </Link>
           </button>
